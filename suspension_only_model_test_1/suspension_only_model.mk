...
## Generated on : Mon Jul 26 15:48:26 2021
...
OBJS = rt_logging.o rt_backsubrr_dbl.o rt_forwardsubrr_dbl.o rt_lu_real.o rt_matrixlib_dbl.o rtGetInf.o rtGetNaN.o rt_nonfinite.o suspension_only_model.o suspension_only_model_capi.o suspension_only_model_data.o rt_logging_mmi.o rtw_modelmap_utils.o
...
rt_backsubrr_dbl.o : $(START_DIR)/suspension_only_model_grt_rtw/rt_backsubrr_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_forwardsubrr_dbl.o : $(START_DIR)/suspension_only_model_grt_rtw/rt_forwardsubrr_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_lu_real.o : $(START_DIR)/suspension_only_model_grt_rtw/rt_lu_real.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_matrixlib_dbl.o : $(START_DIR)/suspension_only_model_grt_rtw/rt_matrixlib_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"
